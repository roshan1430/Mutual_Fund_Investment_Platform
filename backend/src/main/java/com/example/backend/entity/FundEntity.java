...
public class FundEntity {
    ...
    @ElementCollection
    @CollectionTable(name = "fund_holdings", joinColumns = @JoinColumn(name = "fund_id"))
    @Column(name = "holding")
    private List<String> topHoldings;

    public FundEntity() {}

    public FundEntity(String name, String category) {
        this.name = name;
    ...
    public List<String> getTopHoldings() {
        return topHoldings;
    }

    public void setTopHoldings(List<String> topHoldings) {
